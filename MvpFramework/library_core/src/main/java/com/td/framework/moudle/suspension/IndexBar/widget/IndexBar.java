package com.td.framework.moudle.suspension.IndexBar.widget;
...
import com.td.framework.moudle.suspension.IndexBar.helper.IIndexBarDataHelper;
import com.td.framework.moudle.suspension.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndexBarTextColor = Color.BLACK;//默认未按下字体是纯黑色
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.IndexBar_indexBarTextSize) {
                ...
                mIndexBarTextColor = typedArray.getColor(attr, mIndexBarTextColor);
            }
        }
        typedArray.recycle();
    ...
    private int getPosByTag(String tag) {
        ...
        for (int i = 0; i < mSourceDatas.size(); i++) {
            if (tag.equals(mSourceDatas.get(i).getTopTag())) {
