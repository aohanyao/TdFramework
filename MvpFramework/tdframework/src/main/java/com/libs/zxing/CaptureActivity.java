 ...
 * 二维码扫描页面
 */
public final class CaptureActivity extends TDBaseActivity implements
        SurfaceHolder.Callback {

    private static final String TAG = CaptureActivity.class.getSimpleName();
    TextView barcodeNotice;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.toolbar);
         ...
         barcodeNotice = (TextView)findViewById(R.id.barcode_notice);
        tvScanTitle = (TextView)findViewById(R.id.tv_scan_title);
        initChangerToolbarGradientColor(R.color.white);
        hasSurface = false;
        inactivityTimer = new InactivityTimer(this);
//        inactivityTimer.s
        beepManager = new BeepManager(this);
        ScanfQrCodeDto scanfQrCodeDto = (ScanfQrCodeDto) getIntent().getSerializableExtra(Constant.INTENT_DATA_KEY);

        if (scanfQrCodeDto != null) {
            mToolbar.setTitle("");
            barcodeNotice.setText(scanfQrCodeDto.msgTip);
            tvScanTitle.setText(scanfQrCodeDto.title);
        }
    ...
    public void handleDecode(Result rawResult, Bitmap barcode) {
        ...
        //TODO 这里是扫描二维码成功结果页面  在这里进行一些业务逻辑的处理

        Intent intent = new Intent();
        intent.putExtra(Constant.INTENT_DATA_KEY, text);
        setResult(RESULT_OK, intent);
        L.e("result-->" + text);
        finish();
        JumpAnimUtils.out(this);
    }
