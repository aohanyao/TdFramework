package com.td.framework.ui.chart.renderer;
 ...
 */
public class HorizontalBarChartRoundRenderer extends BarChartRenderer {
    private int radius = 4;

    public HorizontalBarChartRoundRenderer(BarDataProvider chart, ChartAnimator animator,
                                           ViewPortHandler viewPortHandler,int radius) {
