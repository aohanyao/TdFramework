...
public class DialogHelper {
    ...
    public void showLoadingDialog(String msg, boolean cancelable) {
        ...
        TextView mTvDialogMessage = mDialogLoadingView.findViewById(R.id.tv_loading_text);
        AVLoadingIndicatorView avLoading = mDialogLoadingView.findViewById(R.id.av_loading);
        if (avLoading != null) {
