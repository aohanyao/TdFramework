 ...
 */
public class StickToTitleScrollView extends ScrollView {
    ...
    public StickToTitleScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StickToTitleScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (redirectTouchToStickyView) {
            ev.offsetLocation(0, ((getScrollY() + mStickyViewTopOffset) - mCurrentStickyView
                    .getTop() - 25));
        }
